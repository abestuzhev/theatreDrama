$(document).ready(function() {
    ...
    function WhiteStyle(){
        if ($.cookie("CecutientCookie")=="on"){
            ...
            $('.header_logo').css({"fill" : "#000"});
            $('.header_logo-letter').css({"fill" : "#fff"});
    ...
    function BlackStyle(){
        if ($.cookie("CecutientCookie")=="on"){
            ...
            // $('body, html, .hearder *, .main *, .footer *').css({"color":"#fff"});
            ...
            $('.header_logo').css({"fill" : "#fff"});
            $('.header_logo-letter').css({"fill" : "#000"});
